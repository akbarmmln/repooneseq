...
cron.schedule("*/1 * * * * *", async function() {
    ...
    try
    {
        var check1 = await dbConnection.query("UPDATE booking SET jumlahpenumpang = 0 WHERE status_pembayaran = 'Expired'",
        { type: sequelize.QueryTypes.UPDATE, transaction: transaction },
        {
            raw: true
        });
